...
export default function PrimerPeriodoCard() {
  ...
  return (
    <div className="bg-white dark:bg-[#1F1822] rounded-3xl border border-pink-100 dark:border-[#3A2F3F] px-6 py-8">
      <div className="text-center mb-6">
        <div className="text-5xl mb-3">🌸</div>
        <h2 className="text-xl font-bold text-gray-800 dark:text-[#F4F1F5]">
          Empecemos por tu último período
        </h2>
        <p className="text-sm text-gray-500 dark:text-[#B4ABB8] mt-3 max-w-sm mx-auto leading-relaxed">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-sm mx-auto">
        ...
        <p className="text-[11px] text-gray-400 dark:text-[#8A8190] text-center leading-relaxed">
