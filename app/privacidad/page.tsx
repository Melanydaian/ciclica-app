  ...
  return (
    <div className="min-h-screen bg-[#FFF9FB] py-10 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-pink-100 p-6 md:p-10">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mt-4 mb-2">Política de Privacidad</h1>
        <p className="text-xs text-gray-400 mb-8">Última actualización: 29 de mayo de 2026</p>
        ...
        <div className="prose prose-sm md:prose-base max-w-none text-gray-700 space-y-5 leading-relaxed">
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Qué guardamos</h2>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Cómo usamos esos datos</h2>
          <ul className="list-disc pl-5 space-y-2">
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Qué NO hacemos</h2>
          <ul className="list-disc pl-5 space-y-2">
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Tus derechos</h2>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Compartir con tu profesional de salud</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Seguridad técnica</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Importante: no somos un dispositivo médico</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Contacto</h2>
          <p>
