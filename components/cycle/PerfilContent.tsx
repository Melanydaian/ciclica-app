  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="w-full py-3 rounded-xl border border-gray-200 dark:border-[#3A2F3F] text-gray-500 dark:text-[#B4ABB8] text-sm hover:text-gray-700 dark:text-[#E5DBE8] hover:bg-gray-50 transition-colors"
      >
        Cerrar sesión
      </button>
    </div>
