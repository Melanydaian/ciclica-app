    ...
    <div className="space-y-4">
      <div className="bg-white dark:bg-[#1F1822] rounded-2xl border border-pink-100 dark:border-[#3A2F3F] px-5 py-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-gray-800 dark:text-[#F4F1F5]">Compartir con tu ginecóloga</h3>
        </div>
        ...
        {shareToken && shareUrl ? (
          <div className="space-y-3">
            <div className="p-3 rounded-xl bg-pink-50 dark:bg-pink-500/10 border border-pink-100 dark:border-[#3A2F3F]">
              <p className="text-[10px] font-semibold uppercase tracking-wider text-pink-600 mb-1">
                Tu link
              </p>
              <p className="text-xs text-gray-700 dark:text-[#E5DBE8] break-all font-mono">{shareUrl}</p>
      ...
      <div className="bg-white dark:bg-[#1F1822] rounded-2xl border border-pink-100 dark:border-[#3A2F3F] px-5 py-6">
        <div className="flex items-center gap-2 mb-4">
          <span className="text-lg">🔒</span>
          <h3 className="text-sm font-semibold text-gray-800 dark:text-[#F4F1F5]">Tu privacidad y datos</h3>
        </div>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <span className="text-gray-400 dark:text-[#8A8190]">→</span>
          </button>
      ...
      <div className="bg-white dark:bg-[#1F1822] rounded-2xl border border-red-100 px-5 py-6">
        ...
        {!showConfirm ? (
          ...
          <div className="space-y-3">
            <p className="text-xs text-gray-700 dark:text-[#E5DBE8]">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="py-2 rounded-lg border border-gray-200 dark:border-[#3A2F3F] text-gray-600 dark:text-[#C9BFCB] text-xs font-medium"
              >
                Cancelar
              </button>
              <button
