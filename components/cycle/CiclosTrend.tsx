    ...
    <div className="bg-white rounded-2xl border border-pink-100 px-5 py-6">
      <div className="mb-1">
        ...
        <div className="flex items-baseline gap-2 mt-1">
          ...
          <span className="text-xs text-gray-400">días de promedio</span>
        </div>
              ...
              <div key={i} className="flex-1 flex flex-col items-center gap-2 h-full justify-end">
                <span
                  className={`text-[11px] font-bold tabular-nums ${
                    s.current ? 'text-pink-500' : 'text-gray-400'
                  }`}
                >
                  {s.length}
                </span>
      ...
      <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100 text-[11px]">
        <span className="text-gray-400">
          📏 Lo normal: <span className="font-semibold text-gray-600">21 a 35 días</span>
        </span>
        <span className="text-gray-400">
          📊 Tu variación: <span className="font-semibold text-gray-600">{variability} días</span>
        </span>
      </div>
    </div>
  )
