  ...
  return (
    <div className="min-h-screen bg-[#FFF9FB] py-10 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-pink-100 p-6 md:p-10">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mt-4 mb-2">Términos de Uso</h1>
        ...
        <div className="prose prose-sm md:prose-base max-w-none text-gray-700 space-y-5 leading-relaxed">
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Qué es Cíclica</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Tu cuenta</h2>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Uso responsable</h2>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Limitaciones de responsabilidad</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Plan gratuito y planes pagos</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Baja de servicio</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-gray-800 mt-6">Cambios a estos términos</h2>
          <p>
