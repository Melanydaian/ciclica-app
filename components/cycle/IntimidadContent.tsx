...
const FASE_LABEL: Record<string, { label: string; color: string; bg: string }> = {
  menstrual:  { label: 'Menstrual', color: '#9D174D', bg: '#FCE7F3' },
  folicular:  { label: 'Folicular', color: '#065F46', bg: '#D1FAE5' },
  ovulatoria: { label: 'Ovulatoria', color: '#92400E', bg: '#FEF3C7' },
  lutea:      { label: 'Lútea', color: '#5B21B6', bg: '#EDE9FE' },
  desconocida: { label: 'Sin fase', color: '#6B7280', bg: '#F3F4F6' },
}
  ...
  return (
    <div className="space-y-4">
      <div className="pb-2">
        ...
        <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mt-1">Momentos íntimos</h1>
      ...
      {lastPeriod ? (
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-pink-100 dark:border-gray-800 px-6 py-8 text-center">
              ...
              return (
                <div key={i} className="flex items-start gap-3 py-3 border-b border-gray-50 dark:border-gray-800 last:border-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-2 mt-1.5 text-[11px] text-gray-500 dark:text-gray-400">
