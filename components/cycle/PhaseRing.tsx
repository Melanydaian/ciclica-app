...
export default function PhaseRing({
  ...
  return (
    <div className="bg-white rounded-3xl border border-pink-100 px-6 py-8 shadow-sm">
      ...
      <div className="relative flex items-center justify-center" style={{ height: radius * 2 + 8 }}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <div className="text-7xl font-bold text-gray-800 leading-none mt-0.5 tabular-nums">
            {dayOfCycle}
          </div>
